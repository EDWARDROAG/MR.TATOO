/**
 * ============================================================
 * ARCHIVO: CajeroUploadReceipt.jsx
 ...
 * ============================================================
 * PROPÓSITO:
 *   Página / vista React — CajeroUploadReceipt.jsx.
 *
 * FUNCIONES / API (contrato exporta):
 *   CajeroUploadReceipt (default)
 *
 * DEPENDENCIAS CLAVE:
 *   —
 *
...
const CajeroUploadReceipt = ({ isOpen, onClose, onConfirm, existingFile }) => {
  const [selectedFile, setSelectedFile] = useState(existingFile || null);
...
export default CajeroUploadReceipt;
 ...
 * ============================================================
 * PROPÓSITO:
 *   Configuración de entorno / infraestructura — printer.js.
 *
 * FUNCIONES / API (contrato exporta):
 *   FONT_CONFIG, ESC_POS_COMMANDS, SPECIAL_CHARS, TICKET_FORMATS,
 *   INTERFACE_CONFIG, getCommand, getActiveInterface, LINE_HEIGHT
 *
 * DEPENDENCIAS CLAVE:
 *   —
 *

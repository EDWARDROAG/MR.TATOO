 ...
 * ============================================================
 * PROPÓSITO:
 *   Controlador HTTP — endpoints de auth.
 *
 * FUNCIONES / API (contrato exporta):
 *   login, register, verify, getProfile, updateProfile, logout,
 *   refreshToken, changePassword, forgotPassword, resetPassword
 *
 * DEPENDENCIAS CLAVE:
 *   User, logger, emailService
 *
...
const refreshToken = async (req, res) => {
  try {
    // authMiddleware ya verificó el JWT (no se aceptan tokens expirados)

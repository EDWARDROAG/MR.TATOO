 ...
 * ============================================================
 * PROPÓSITO:
 *   Controlador HTTP — endpoints de report.
 *
 * FUNCIONES / API (contrato exporta):
 *   getDashboardMetrics, getSalesReport, getSalesBySellerReport,
 *   getTopProductsReport, getInventoryReport, getCashierClosureReport
 *
 * DEPENDENCIAS CLAVE:
 *   Sale, SaleItem, Product, User, Log, database
 *

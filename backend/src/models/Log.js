 ...
 * ============================================================
 * PROPÓSITO:
 *   Modelo / acceso a datos — Log.js.
 *
 * FUNCIONES / API (contrato exporta):
 *   create, findById, findAll, findByUserId, findByAction, findByDateRange,
 *   cleanOldLogs, getStatsByAction, getRecent, deleteByUserId, getTotalCount
 *
 * DEPENDENCIAS CLAVE:
 *   database
 *

 ...
 * ============================================================
 * PROPÓSITO:
 *   Modelo / acceso a datos — SaleItem.js.
 *
 * FUNCIONES / API (contrato exporta):
 *   create, createMultiple, findById, findBySaleId, remove, removeBySaleId,
 *   getTotalBySaleId, getProductSalesStats, getSalesByProductId,
 *   getTopProductsByPeriod, hasBeenSold
 *
 * DEPENDENCIAS CLAVE:
 *   database
 *
...
const create = async (itemData, client = null) => {
